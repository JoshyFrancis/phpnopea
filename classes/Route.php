...
function load_classes(){
	...
	include App::$classes_path.'Phpnopea_QueryException.php';//used in DB class
	...
	include App::$classes_path.'Phpnopea_User.php';
		Route::$auth=new Auth();
	include App::$classes_path.'Phpnopea_Session.php';	
	include App::$classes_path.'Session.php';
	include App::$classes_path.'Phpnopea_VerifyCsrfToken.php';
...
function load_laravel_classes(){
	...
	include App::$classes_path.'Phpnopea_Hash.php';
	include App::$classes_path.'Phpnopea_EncryptCookies.php';
	include App::$classes_path.'Phpnopea_TrimStrings.php';
	
		
	include App::$classes_path.'Validator.php';
			
		
		include App::$classes_path.'Phpnopea_Controller.php';	
		include App::$classes_path.'Phpnopea_AuthenticatesUsers.php';
		//include App::$classes_path.'Phpnopea_Session.php';
		include App::$classes_path.'Phpnopea_Auth.php';
		include App::$classes_path.'Phpnopea_Storage.php';
