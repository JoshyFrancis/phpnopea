...
error_reporting(E_ALL);
		...
		App::$file_view=__DIR__.'/classes/View.php';
		App::$public_path= __DIR__ .'/public/' ;
		
		App::$http_path=__DIR__ .'/app/Http/';
		App::$controllers_path=__DIR__ .'/app/Http/Controllers/';
		App::$view_path=__DIR__ .'/resources/views/';
		App::$file_env=__DIR__ .'/.env';
		App::$file_web=__DIR__ .'/routes/web.php';
