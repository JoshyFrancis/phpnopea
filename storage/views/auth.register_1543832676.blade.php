        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo  url('register') ;?>">
                        <?php echo  csrf_field() ;?>
                        ...
                        <div class="form-group<?php echo  $errors->has('name') ? ' has-error' : '' ;?>">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control" name="username" value="<?php echo  old('username') ;?>" required autofocus>
